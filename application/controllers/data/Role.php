...
class role extends CI_Controller {
    ...
    public function get_array() {
        $this->lib->check_session();
        $dataData = array(
            'role_nama' => urldecode($_POST["role_nama"]),
            'role_keterangan' => urldecode($_POST["role_keterangan"]), 
    ...
    public function add() {
        $this->lib->check_session();
        $temp = '0'; 
        $this->form_validation->set_rules('role_nama', 'Nama Divisi', 'required|max_length[30]|is_unique[data_role.role_nama]');
        $error = '';
    ...
    public function edit() {
        $this->lib->check_session();
        $this->form_validation->set_rules('role_nama', 'Nama Divisi', 'required|max_length[30]|is_unique_edit[data_role.role_nama.' . $_POST['datamodel'] . ']');
        $error = '';
        if (isset($_POST['ubah'])) {
            if ($this->form_validation->run() == FALSE) {
                $data['ubah'] = 'ubah';
