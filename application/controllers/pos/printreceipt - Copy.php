	 ...
	 public function prints(){ 
		...
		if (isset($urlParts['query'])){
			...
			if(isset($qs[WebClientPrint::CLIENT_PRINT_JOB])){
				...
				// if(count($profil))
				// {  
					$header=$this->align("center",40,"Toko Artomoro");
					$profile_alamat=$this->align("center",33,"Jalan Jend Sudirman Pinggir Sedikit"); 
				...
				{ 
					...
					$cmds .= $newLine;
					$cmds .= $esc . '!' . '0x00'; //Emphasized + Double-height + Double-width mode selected (ESC ! (8 + 16 + 32)) 56 dec => 38 hex
					$cmds .= ucfirst($profile_alamat); //text to print
				}
