                ...
                <div ng-controller="DemoCtrl">
                    ...
                    <div class="row" >
                        ...
                        <div style="" class="col-md-2 " >
                            <button style="" ng-click="tableParams.sorting({})" onclick="clear_sorting()" class="btn btn-default btn-w100">Clear Sorting</button>
                        </div>
                        <div class="col-md-2" >
                            <a style="" class="btn btn-primary btn-w100" ng-mousedown="csv.generate()" ng-href="{{ csv.link()}}" download="log.csv">Export to CSV</a>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <table  ng-table="tableParams"   class="table ng-table-responsive latar" export-csv="csv">
                                <tr ng-repeat="(datamodel, user) in $data | filter:user" ng-class="{ 'emphasis': user.log_action == '<?php echo $this->session->userdata("log_action") ?>'}">
                                    ...
                                    <td class="NamaMenu" align="center" data-title="'Nama Menu'" sortable="'log_menu'">
                                ...
                                <center>
                                    ...
                                    <div id="toolbar-options-{{$index}}" class="hidden">
                                        <a  title="Lihat Data" href="" id="log-{{$index}}" datamodel={{user.datamodel}} onclick="form_lihat(this)">
