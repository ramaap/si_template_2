    ...
    <body ng-app="main">
            ...
            <div id="container">
					...
					<div class="row">
						...
						<div class="col-md-4"> 
							<input id="profile_title" class="form-control" name="profile_title" type="text" size="28" required="" value="<?php echo set_value('user_name', $profile->profile_title); ?>" /> 
					...
					<div class="row">
						...
						<div class="col-md-4"> 
							<input class="form-control" id="profile_alamat" name="profile_alamat" type="text" autocomplete="off" size="28" required="" value="<?php echo set_value('password_lama',$profile->profile_alamat); ?>" /> 
					...
					<div class="row">
						...
						<div class="col-md-4"> 
							<input class="form-control" id="profile_telepon" name="profile_telepon" type="text" size="28" required="" value="<?php echo set_value('password_baru', $profile->profile_telepon); ?>" /> 
					...
					<div class="row">
						...
						<div class="col-md-4"> 
							<input class="form-control" id="profile_fax" name="profile_fax" type="text" size="28" required="" value="<?php echo set_value('password_baru_konfirmasi', $profile->profile_fax); ?>" /> 
